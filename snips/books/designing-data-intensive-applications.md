...
- 2\. A timing anomaly that causes events to appear in an unexpected, nonsequential order.
...
- Grouping together several reads and writes into a logical unit, in order to sim‐ plify error handling and concurrency issues.

two-phase commit (2PC)

- An algorithm to ensure that several data‐ base nodes either all commit or all abort a transaction.
