...
* [https://www.computerhope.com/jargon.htm](https://www.computerhope.com/jargon.htm)
* [https://github.com/dnnrly/abbreviate/blob/master/data/en-us/common](https://github.com/dnnrly/abbreviate/blob/master/data/en-us/common)

## Symbols

Note that :

`for CLI` about Command-Line Interface `for Go` about Go Programming Language `for kernel` about Linux \(kernel\) `for SQL` about SQL `for Regex` about Regular Expression ……
...
Reference : [https://www.computerhope.com/keys.htm](https://www.computerhope.com/keys.htm)
...
* abs : absolute
* abt : about
* ACID : \[Atomicity, Consistency, Isolation, Durability\]\([https://en.wikipedia.org/wiki/ACID\_\(computer\_science](https://en.wikipedia.org/wiki/ACID_%28computer_science)\)\)
...
* AIDA : \[Awareness → Interest → Desire → Action\]\([https://en.wikipedia.org/wiki/AIDA\_\(marketing](https://en.wikipedia.org/wiki/AIDA_%28marketing)\)\)
...
* const : constant
* constr : \[constructor\]\([https://en.wikipedia.org/wiki/Constructor\_\(object-oriented\_programming](https://en.wikipedia.org/wiki/Constructor_%28object-oriented_programming)\)\)
* conv : convert
* COW : [Copy-On-Write](https://en.wikipedia.org/wiki/Copy-on-write)
* cp : \[copy\]\([https://en.wikipedia.org/wiki/Copy\_\(command](https://en.wikipedia.org/wiki/Copy_%28command)\)\)
...
* FIFO : \[First In First Out\]\([https://en.wikipedia.org/wiki/FIFO\_\(computing\_and\_electronics](https://en.wikipedia.org/wiki/FIFO_%28computing_and_electronics)\)\)
...
* gid : group id
* glob : \[glob patterns\]\([https://en.wikipedia.org/wiki/Glob\_\(programming](https://en.wikipedia.org/wiki/Glob_%28programming)\)\)
...
* id : IDs - 多个 ID
* idx : index
* i.e. : \[id est\]\([https://en.wikipedia.org/wiki/List\_of\_Latin\_phrases\_\(I\)\#id\_est\)（拉丁语）即（也就是）](https://en.wikipedia.org/wiki/List_of_Latin_phrases_%28I%29#id_est%29（拉丁语）即（也就是）)
* img : image
* imp : improve
* impl : implement
* incr : increase
...
* init : initiate
* ins : insert
* int : \[integer\]\([https://en.wikipedia.org/wiki/Integer\_\(computer\_science](https://en.wikipedia.org/wiki/Integer_%28computer_science)\)\)     \| [interrupt](https://en.wikipedia.org/wiki/Interrupt)
* io : input/output
...
* jar : \[Java Archive file\]\([https://en.wikipedia.org/wiki/JAR\_\(file\_format](https://en.wikipedia.org/wiki/JAR_%28file_format)\)\)
* jd : job description
...
* lang : language
* LB : \[load balancing\]\([https://en.wikipedia.org/wiki/Load\_balancing\_\(computing](https://en.wikipedia.org/wiki/Load_balancing_%28computing)\)\) \( or balancer \)
* len : length
...
* mk : \[make\]\([https://en.wikipedia.org/wiki/Make\_\(software](https://en.wikipedia.org/wiki/Make_%28software)\)\) \( for CLI \)
...
* multi : multiple
* mv : \[move\]\([https://en.wikipedia.org/wiki/Move\_\(command](https://en.wikipedia.org/wiki/Move_%28command)\)\) \( for CLI \)
* MVCC : 多版本并行控制
...
* OOTB : \[out-of-the-box\]\([https://en.wikipedia.org/wiki/Out\_of\_the\_box\_\(feature](https://en.wikipedia.org/wiki/Out_of_the_box_%28feature)\)\)
...
* proc : \[process\]\([https://en.wikipedia.org/wiki/Process\_\(computing](https://en.wikipedia.org/wiki/Process_%28computing)\)\)
* prof : profiler \( 性能 \) 分析器 / \[profiling\]\([https://en.wikipedia.org/wiki/Profiling\_\(computer\_programming](https://en.wikipedia.org/wiki/Profiling_%28computer_programming)\)\)
...
* q : \[queue\]\([https://en.wikipedia.org/wiki/Queue\_\(abstract\_data\_type](https://en.wikipedia.org/wiki/Queue_%28abstract_data_type)\)\) \| question \| quiet \( for CLI \)
...
* serv : server \| service
* sess : session
* sh : \[shell\]\([https://en.wikipedia.org/wiki/Shell\_\(computing](https://en.wikipedia.org/wiki/Shell_%28computing)\)\)
...
* slb : \[server load balancing\]\([https://en.wikipedia.org/wiki/Load\_balancing\_\(computing](https://en.wikipedia.org/wiki/Load_balancing_%28computing)\)\)
...
* stk : \[stack\]\([https://en.wikipedia.org/wiki/Stack\_\(abstract\_data\_type](https://en.wikipedia.org/wiki/Stack_%28abstract_data_type)\)\)
...
* tmp : temporary
* tmpl : template
* top : \[table of processes\]\([https://en.wikipedia.org/wiki/Top\_\(software](https://en.wikipedia.org/wiki/Top_%28software)\)\) \( for CLI \)
