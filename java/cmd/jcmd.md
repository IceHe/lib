...
* `man jcmd`
* Java SE 14 Docs - Tools References - `jcmd` :  [https://docs.oracle.com/en/java/javase/14/docs/specs/man/jcmd.html](https://docs.oracle.com/en/java/javase/14/docs/specs/man/jcmd.html)
...
* options:
  ...
  * `dumponexit` : \(Optional\) Flag for writing the recording to disk when the Java Virtual Machine \(JVM\) shuts down.
    ...
    * \(For example: id-1-2019\_12\_12\_10\_41.jfr\) \(BOOLEAN, false\)
...
* options:
  ...
  * `jmxremote.ssl.need.client.auth` : \(Optional\) Sets com.sun.management.jmxre mote.need.client.auth
    * \(STRING, no default value\)
  * `jmxremote.ssl.config.file` : \(Optional\) Sets com.sun.management.jmxremote. ssl\_config\_file
    * \(STRING, no default value\)
  ...
  * `jdp.address` : \(Optional\) Sets com.sun.management.jdp.address
    * \(STRING, no default value\)
  * `jdp.source_addr` : \(Optional\) Sets com.sun.management.jdp.source\_addr
    * \(STRING, no default value\)
...
* options:
  ...
  * `output` : \(Optional\) The name or index \(\#\) of output to configure.
    * \(STRING, no default value\)
  * output\_options: \(Optional\) Options for the output.
    * \(STRING, no default value\)
