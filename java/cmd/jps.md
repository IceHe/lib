...
* Java SE 11 Docs - Tools References - `jps` : [https://docs.oracle.com/en/java/javase/11/tools/jps.html](https://docs.oracle.com/en/java/javase/11/tools/jps.html)
...
* `-V` _Output the arguments passed to the JVM through the flags file_
  * _\(the .hotspotrc file or the file specified by the -XX:Flags= argument\)._
