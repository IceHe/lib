...
* Website : [icehe.xyz](https://icehe.xyz) - powered by [docsify](_docsify/)
...
* _\*_ [_Java Concurrency in Pratice_](books/java-concurrency-in-pratice.md) _\( to read \)_
* _\*_ [_Linux Kernel_](books/linux.md) _\( note-taking \)_
...
* [Docker](snips/docker/) : Command & Composor
* [Alpine Linux](snips/docker/alpine.md) : minimal OS image

Markdown

* [Style Guide](snips/markdown/)
* [Lint Tool : mdl](snips/markdown/lint.md)
...
* [LSM Tree](snips/lsm-tree.md) : Log-Structured Merge-Tree
...
* Simple HTTP Service
  * [init.d](snips/init.d.md) with `php -S`
  * [Nginx](snips/nginx.md)
* How to mail
...
* [Tools](marks/tools/) : 利器 - 软件 / 物件的推荐
  * [Software](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/marks/tools/README/README.md#软件) : 软件
  * [Hardware](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/marks/tools/hardware/README.md) : 硬件
  * [Life](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/marks/tools/life/README.md) : 生活
* [Efficiency](mac/efficiency.md) : 效率指南
* [Shortcuts](mac/shortcuts/) : 快捷键
* [Initialize](mac/initialize.md) : 系统初始化
* [JVM Options Optimaization](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/mac/jetbrains/README.md)
...
* [bash](cmd/bash/) : GNU Bourne-Again SHell \( draft \)
...
* [ping](cmd/p/ping.md) : send ICMP ECHO\_REQUEST to network hosts
...
* [rsync](cmd/rsync.md) : transfer files
...
* [_sysctl_](cmd/s/sysctl.md) _: configure kernel parameters at runtime_
...
* [_ulimit_](cmd/u/ulimit.md) _: system resource limit to shell_
* [_uname_](cmd/u/uname.md) _: print system information_
* [uniq](cmd/u/uniq.md) : report or omit repeated lines
* [_uptime_](cmd/u/uptime.md) _: show how long system has been running_
* [vim](cmd/v/vim.md) : terminal text editor
* [visudo](cmd/v/visudo.md) : edit the sudoers file
* [_w_](cmd/w/w.md) _: show who is logged on & what they are doing_
...
* [_whoami_](cmd/w/whoami.md) _: print effective userid_
* [xargs](cmd/x/xargs.md) : build and execute command lines from standard input
* [_xxd_](cmd/x/xxd.md) _: make a hexdump or do the reverse_
...
* PHP : [Functions & Scripts](scripts/php.md)
...
* _Newly_
  * [_PDCA_](snips/principles/pdca.md) _: Plan → Do → Check → Act \( Adjust \)_
  * [_AIDA_](snips/principles/aida.md) _: Attention → Interest → Desire → Action_
...
* _Newly_
  * [_VicodinXYZ's Life Beliefs_](read/life-beliefs.md)
  * [_Focus On Learning and Creating Rather Than Entertainment and Distraction_](read/focus-on-learning-and-creating-rather-than-being-entertained-and-distracted.md)
...
* Time Mgt. : [Life Logs](lifelogs/) & [Log Format](lifelogs/time-mgt.md) _\( &lt;= 2016.10 \)_
