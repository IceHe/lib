...
start:
 ...
 <b><u>;当移位数大于1时，要先将移位数置于CL中，然后再用CL移位。

     ;可以使用8位立即数指定范围从1到31的移位次数</u>
...
<div>（以上为BCD码中的8421版本，其它详情请看<a href="http://baike.baidu.com/link?url=jh2w0DfroFs6zztCYEmXpxVTIAWmpHaF7cJ6lWWxXLCniVWaxFs_tbJ_HwAMHl2_dOorIxg8MwsTTgJCg8xs7_">百度百科</a>）</div>
...
start:
     ...
     **out 70h, al
     ...
     and al, 00001111b;保留低四位add ah, 30h     ;+30h 转换为对应数字的ascii
...
<div><img width="619px" height="69px" src="http://7vzp68.com1.z0.glb.clouddn.com/Assembly%20Language%20-%20Note%2011/tmp.png" />
</div>
...
circle:
     ...
     **mov ah, 2     ;设置光标位置，int 10h的2号子程序
     ...
     mov dx, 0     **;ds:dx指向字符串，&apos;$&apos;作为结束符mov ah, 9     ;在光标位置处显示字符串，int 21h的9号子程序
