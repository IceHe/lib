...
然后以下就是**assume ds:data**对**编译**实际的**影响**：
 
mov al, a[si] 编译为 mov al, [si+0]
<div><img width="px" height="px" src="http://7vzp68.com1.z0.glb.clouddn.com/Assembly%20Language%20-%20Note%2013/e8c800492bf9619ab7e61184592c770c.png" /></div> 
add b, ax 编译为 add [8], ax
<div><img width="px" height="px" src="http://7vzp68.com1.z0.glb.clouddn.com/Assembly%20Language%20-%20Note%2013/488a2b294983eb6c4dc88d71380790e8.png" /></div> 

 
当**删除**以上源程序中assume ..., **ds:data**中的ds:data后，
 
用masm**编译**时，会**产生****错误**，报错信息如下：
<div><img width="px" height="px" src="http://7vzp68.com1.z0.glb.clouddn.com/Assembly%20Language%20-%20Note%2013/18512c4d794b8a6c2c7ed46b68c9bcf7.png" /></div> 
...
和 **字符 “0” ~ “F”**（16进制表示法）之间建立的**映射关系**为：
 
以**数值N为table表**中的**偏移**，可以**找到对应字符**。
