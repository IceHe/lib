...
def upgrade_test(tuner_count: int, exp_total: int, upgrade: callable) -> dict:
    ...
    if print_detail:
        ...
        print("双暴声骸:", triple_crit_total)
        print()

    return {
        "double_crit_total": triple_crit_total,
...
if __name__ == "__main__":
    ...
    upgrade_stats(loop_count, tuner_count, exp_total, upgrade_41a)
    ...
    upgrade_stats(loop_count, tuner_count, exp_total, upgrade_221a)

    print("=======================================================")
    print("先开2个词条，再开1个词条；如果前两个词条没有双暴但有大攻击，再开1个词条")
    upgrade_stats(loop_count, tuner_count, exp_total, upgrade_23or212a)
