...
def test_convene():
    ...
    print(f"【平均每抽获得 {afterglow_coral} / {round(avg_convene, 2)} ≈ {round(afterglow_coral / avg_convene, 3)} 个余波珊瑚】")
