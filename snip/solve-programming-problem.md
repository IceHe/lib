...
-   **DP - Dynamic Programming（动态规划）**
    ...
    -   **Subsequence 子序列** → DP
        ...
        否则根据「选或不选」的逻辑使用递归解法，时间复杂度会飙升到 2^n
        （至少需要「记忆化搜索」的技巧来降低执行耗时）。

        e.g. [516. 最长回文子序列](https://leetcode.cn/problems/longest-palindromic-subsequence/)
...
-   Swap (交换)
    ...
    e.g. [2415. 反转二叉树的奇数层](https://leetcode.cn/problems/reverse-odd-levels-of-binary-tree/)
