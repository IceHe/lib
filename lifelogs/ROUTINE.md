...
- 做一个有价值的人, 对世界有益, 受人尊敬
    ...
    - _越能体现人性尊严的快乐, 越是一种高级的快乐_
        - _我们之所以读书行路, 其实就是希望能够不断地享受高级的快乐_
...
- 结合以上问题 :
    - 高估自己能力, 觉得自己能够做到
    - 沉迷享乐, 很想去玩乐, 其实已经花太多时间玩乐了, 不能再过度了!
    - 踟蹰不前, 觉得该做正事, 但是焦虑,
        于是拖延做正事, 结果继续做那些蠢事
- 当前偏误 :
...
- Doing
    - [ ] 1. 早睡 - 00:00 前躺床, 不玩手机
        ...
        - [ ] 1.3. 躺床, 不玩手机
            - 最好 23:30 最晚 00:30
    - [ ] 读完 技术书 2 本
        - [ ] Understand the JVM ( DOING )
        - [ ] _Java 并发编程实践? ( TBD )_
    - [ ] 笔记 技术书 2 本
        - [ ] Linux Development ( DOING )
        - [ ] Understand the JVM ( DOING )
    - [ ] _TBD…_
...
- 思路 & 做法 :
    - 延迟满足 : 先读书, 再娱乐
        - 奖励 : 每读书 30m, 才能去娱乐 30m _( 暂时控制不住, 总是超时 )_
