...
- "**三思而后行**. "
    - "博弈论: 理性就是 **对你的各种东西设定一个优先级, 并且能够贯彻执行这个优先级**. "
        - 勤回想: 时间的真正价值, **你的一分钟值 3.4 元** (至少 1.8 元)
        - 想清楚: 各种事物的优先级.
        - "做正确的事, 正确地做事. "
- **事不宜迟, 立即去办!**
...
- 反省 / 改进 / 计划 / 取舍 ( 做减法 & 分优先级 )
    ...
    - 1 **Trello** : Life Todo-List - **记录 → 过滤 → 聚焦**
        - _**DingTalk & Aone** : Work Todo-List - 同上_
- 建立良好的时间观念
    - 2 **Alarm** & **Calendar** _& **Due**_ : 什么时间, 就该干什么事 - **专时专用** <!-- 闹钟 & 时间表 -->
...
- 抽象 : 不给别人添麻烦 / 不拖后腿.
- [x] 具体 : 完成工作 - 保质, 保量, 及时. <u>工作任务 一次也不许失败!</u>

截止于 : 2019.12.31 succeeded.
...
- [ ] 1. 早睡 - 00:00 前躺床, 不玩手机
    - [ ] 1.1. 回家立即 (5分钟内准备好) 洗澡 (半小时内完成)
        - 最好 21:00 最晚 22:30 _( 2019.10 完成养成 )_
    - [ ] 1.2. 洗完澡立即 (5分钟内开始) 擦&吹头发至8成干 (半小时完成)
        - 最好 21:30 最晚 23:00
    - [ ] 1.3. 躺床, 不玩手机
        - 最好 00:00 最晚 01:00
- 截止于 : 2019.11.30 failed.
