...
* `man vim`
* Home : [http://www.vim.org/](http://www.vim.org/)
* Docs : [http://www.vim.org/docs.php](http://www.vim.org/docs.php)
* Vim documentation: help : [http://vimdoc.sourceforge.net/htmldoc/](http://vimdoc.sourceforge.net/htmldoc/)
...
* Vim cheatsheet : [https://devhints.io/vim](https://devhints.io/vim)
  * Interactive Vim tutorial : [https://openvim.com/](https://openvim.com/)
* SpaceVim : [https://spacevim.org/](https://spacevim.org/) - Modern Vim Distribution
