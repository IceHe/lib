...
- 《[利器 - 软硬件推荐](/_lru/marks/tools/README.md)》列举了绝大多数笔者用的 Apps 和硬件。
- 《[Mac 快捷键](/mac/shortcuts/README.md)》列举了绝大多数笔者用的快捷键。
...
- 具体详见《[利器 - 软硬件推荐](/_lru/marks/tools/README.md)》，其中列举了绝大多数笔者用的 Apps，包括简要的介绍和进一步的说明
