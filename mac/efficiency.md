...
* 《[利器 - 软硬件推荐](../marks/tools/)》列举了绝大多数笔者用的 Apps 和硬件。
* 《[Mac 快捷键](shortcuts/)》列举了绝大多数笔者用的快捷键。
...
详见 [我的 Chrome 插件](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/mac/tools.md#Chrome-插件)
...
* 网页剪藏：Evernote Web Clipper）和稍后读（Pocket）等……
...
* **命令别名**（Aliases）
  * 通常用来给常用命令指定一个「缩写」，一遍更便捷地输入长的命令组合。作为程序员，我的手速、输入准确率都一般，就特别喜欢输入缩写命令。
    * 例如，我让 gs = git status，gp = git push 等（见 [Git Aliases](../git/#Aliases-别名) ）。
...
* 可以参考：
    ...
    《[用 AppleScript 操作 Evernote / macOS](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/mac/scripts/applescript/evernote-macos.md)》

    《[AppleScript Quick Start 快速入门](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/mac/scripts/applescript/applescript.md)》
...
* 具体详见《[利器 - 软硬件推荐](../marks/tools/)》，其中列举了绝大多数笔者用的 Apps，包括简要的介绍和进一步的说明
* 选读《[Mac 快捷键](shortcuts/)》列举了绝大多数笔者用的快捷键，仅供参考
...
[Keyboard Maestro](https://www.keyboardmaestro.com/main/) **Best**

* 高度自定义的效率工具，加速常用操作，甚至自动化。功能强大，用途甚广，限制你的只有你的想象力
* 可以参考笔者的对其用法的 [简要介绍](https://github.com/IceHe/lib/tree/4e6b7c73229e0e23ff9d6acf7f2ba61d9dacec30/mac/tools.md#快捷键) 或《[Keyboard Maestro 入门指南](https://sspai.com/post/36442)》

[ClipMenu](http://www.clipmenu.com/) **Simple**
...
* 笔者现在没有兴趣和余裕去维持这种更新了，后续应该不会再更新本文了。
* 本文内容最后更新于 2018-10-27
* 记于 2019-01-06
