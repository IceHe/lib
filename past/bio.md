...
- 阿里本地生活 - 前台研发部 蜂鸟跑腿组 - Java 后端 _2020.4 ~ now_
...
- 代码仓库: [GitHub](https://github.com/IceHe) & [GitLab](https://gitlab.com/IceHe)
...
**阿里本地生活 (原饿了么&百度外卖&口碑) - 前台研发部 - 蜂鸟跑腿后端组 - Java 后端** _2019.4 ~ now_
...
- MAPI 微博移动服务技术部: 开发维护移动端 (手机 [客户端](https://itunes.apple.com/cn/app/id350962117) & [H5](https://m.weibo.cn/) 页) 的 API 服务及其 CMS 后台
...
- 重构部门主项目「微博移动端 API 服务」包括登录、HTTP 请求、日志记录等模块
    ...
    - 工作流程自动化: CI 持续集成，固定流程自动化 - 一键/自动/定时完成
        ...
        - 定时仿真环境上线、通知提测、清理代码库 ( branch, tag ) 、issues 管理
