...
- 前文《[搭建个人博客](/past/blog/build.md)》只是简单说明了建站过程和定制点。
...
- 自动导出 自己在 Evernote 上做的 [时间管理日志]](/lifelogs/archived/time-mgt-log.md)
    - 修改内容以适应 Hexo 的文章要求
...
Page 服务的挂载方法，可见前文《[__搭建个人博客__](/past/blog/build.md)》。
